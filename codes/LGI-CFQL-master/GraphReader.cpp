...
vector<Graphcfql *> *GraphReader::LoadGraphFormatA(const string &file_path, unordered_map<string, int> *&label_map,
    ...
    Graphcfql* graph = NULL;
    vector<Graphcfql*>* graph_list = new vector<Graphcfql*>();
...
vector<Graphcfql *> *GraphReader::LoadGraphFormatB(const string &file_path, unordered_map<string, int> *&label_map,
                                               unordered_map<string, int>*& graph_map, unordered_map<int, int>*& label_histogram) {
    ifstream infile(file_path.c_str());
...
vector<Graphcfql *> *GraphReader::LoadGraphFormatC(const string &file_path, unordered_map<string, int> *&label_map,
                                               unordered_map<string, int>*& graph_map, unordered_map<int, int>*& label_histogram) {
    ifstream infile(file_path.c_str());
