...
vector<int> FSC::Query(const Graphcfql *query_graph, vector<int> query_results, int &results_count, int tid ) {
...
void FSC::InitializeDataGraphResource(const vector<Graphcfql *> *data_graphs) {
