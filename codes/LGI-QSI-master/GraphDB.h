...
private:
    ...
    vector<Graphcfql*>* graphs_;                                 // The data graphs stored in db.
...
public:
    ...
    vector<Graphcfql*>* GetDataGraphs() {
        return graphs_;
    }
    ...
    vector<Graphcfql*>* LoadQueryGraphs(const string& file, GraphFormat format);
