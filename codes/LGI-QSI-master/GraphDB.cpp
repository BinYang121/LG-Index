...
vector<Graphcfql*>* GraphDB::LoadQueryGraphs(const string &file, GraphFormat format) {
    vector<Graphcfql*>* query_graphs = NULL;
    ...
    for (unsigned int i = 0; i < query_graphs->size(); ++i) {
