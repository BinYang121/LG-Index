...
private:
    void InitializeDataGraphResource(const vector<Graphcfql *> *data_graphs);
...
public:
    FSC(GraphDB* graphDB);
    ~FSC();
    vector<int> Query(const Graphcfql *query_graph, vector<int> query_results, int &results_count, int tid);
